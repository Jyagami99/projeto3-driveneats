function selecionarPrato(elementoClicado){
    let listaElemento = document.querySelectorAll(".pratos > .produto"); 
  ...
  function selecionarSobremesa(elementoClicado){
      let listaElemento = document.querySelectorAll(".sobremesas > .produto"); 
  ...
  function notificacao(){
    ...
    window.location = `https://wa.me/+5516997108182?text=${encodeURIComponent(texto)}`;
  }